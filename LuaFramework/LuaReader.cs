...
namespace LuaFramework
{
	public static class LuaReader
	{
		...
		private static void ReadProperty<T>(T obj, string propertyName, DynValue propertyValue)
		{
			...
			{
				Console.WriteLine("LuaReader: could not define property \"" + propertyName + "\".");
				throw new Exception();
			}
		}
		...
		public static void ReadClassData<T>(T clrObject, Table luaTable)
		{
			...
			{
				Console.WriteLine("LuaReader: method ReadObjectData called with null object.");
				return;
			}
			if (luaTable == null)
			{
                Console.WriteLine("LuaReader: method ReadObjectData called with null Lua table.");
				return;
			}
		...
		public static void ReadSingleProperty<T>(T clrObject, string propertyName, Table luaTable)
		{
			if (clrObject == null)
			{
                Console.WriteLine("LuaReader: method ReadSingleProperty called with null object.");
				return;
			}
			if (luaTable == null)
			{
                Console.WriteLine("LuaReader: method ReadSingleProperty called with null Lua table.");
				return;
			}
